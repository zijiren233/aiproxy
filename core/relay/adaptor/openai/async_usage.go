...
// FetchAsyncUsage implements model.AsyncUsageFetcher for OpenAI adaptor
...
// fetchVideoJobUsage fetches the status of a video generation job
func (a *Adaptor) fetchVideoJobUsage(
	...
	requestURL, err := url.JoinPath(baseURL, "/video/generations/jobs", jobData.JobID)
	if err != nil {
