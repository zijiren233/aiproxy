...
interface SidebarProps { displayConfig?: Record<string, boolean>; collapsed?: boolean; onToggle?: () => void }
export function Sidebar({ displayConfig = {}, collapsed = false, onToggle }: SidebarProps) {
    ...
    return <aside className={cn("h-full relative flex flex-col transition-all duration-300 bg-[#111827] dark:bg-[#0b1120] border-r border-white/[0.08]", collapsed ? "w-20" : "w-64")}>
